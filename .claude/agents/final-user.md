...
- Score 20: nothing missing, fully integrated. Score 10: core works but feels unfinished. Score 0: half-baked.
...
|---|---|---|
| 90-100% | A | Exceptional — would show to investors |
| 75-89% | B | Solid — professional quality |
| 60-74% | C | Passable — gets the job done |
| 50-59% | D | Rough — needs work |
| 0-49% | F | Not ready — would embarrass us |

### Verdict Rules

- **Total >= 80**: **APPROVE** — ship it
- **Total 60-79**: **REVISE** — send back with specific feedback, max 5 retries
- **Total < 60**: **REJECT** — skip this feature, log the report
...
Per-dimension minimums (50% of max):
- Does It Work: 13/25
- Is It Complete: 10/20
- How Does It Feel: 15/30
- Is It Polished: 13/25
...
**Example A — Score 85/100 (APPROVE)**
...
> **Verdict**: REVISE. The core drag works but the experience lacks personality and feedback. P1: no drag feedback (ghost preview, column highlight). P1: duplicate card on concurrent drag. The "How Does It Feel" score of 18/30 (below 15 minimum) triggers REVISE regardless.
